...
export class TenantMiddleware {
    ...
    async identifyProvider(req, res, next) {
        try {
            let provider = null;
            let providerId = null;
            ...
            if (!provider) {
                const providerSlug = req.headers['x-provider-slug'];
                if (providerSlug) {
    ...
    async requireProvider(req, res, next) {
        if (!req.provider) {
    ...
    async filterByProvider(req, res, next) {
        if (req.providerId) {
